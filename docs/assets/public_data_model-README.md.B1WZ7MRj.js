import{_ as a,c as s,o as n,a4 as p}from"./chunks/framework.D5tr8Gic.js";const q=JSON.parse('{"title":"模块配置文件","description":"","frontmatter":{},"headers":[],"relativePath":"public/data/model-README.md","filePath":"public/data/model-README.md","lastUpdated":1725890410000}'),l={name:"public/data/model-README.md"},e=p(`<h1 id="模块配置文件" tabindex="-1">模块配置文件 <a class="header-anchor" href="#模块配置文件" aria-label="Permalink to &quot;模块配置文件&quot;">​</a></h1><h3 id="基础模块配置文件说明" tabindex="-1">基础模块配置文件说明 <a class="header-anchor" href="#基础模块配置文件说明" aria-label="Permalink to &quot;基础模块配置文件说明&quot;">​</a></h3><p>模块配置是给升级版本并下载 liblcl 和 cef 提供的配置参数</p><p>应当属于基础配置，在升级energy版本时使用这里的模块配置</p><h3 id="文件说明" tabindex="-1">文件说明 <a class="header-anchor" href="#文件说明" aria-label="Permalink to &quot;文件说明&quot;">​</a></h3><h4 id="基础配置文件-model-base-config-json" tabindex="-1">基础配置文件: model-base-config.json <a class="header-anchor" href="#基础配置文件-model-base-config-json" aria-label="Permalink to &quot;基础配置文件: model-base-config.json&quot;">​</a></h4><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>内容 JSON 格式， 它提供下载源和支持系统架构配置</span></span>
...
<span class="line"><span>}</span></span>
<span class="line"><span>字段说明:</span></span>
<span class="line"><span>  字段和 liblcl 模块配置含义完全一样</span></span></code></pre></div>`,11),o=[e];function t(i,c,d,u,r,h){return n(),s("div",null,o)}const m=a(l,[["render",t]]);export{q as __pageData,m as default};
